...
namespace Unity.Muse.Chat.Tokenization
{
    ...
    /// </summary>
    class Gpt2Splitter : IConverter<SubString, IEnumerable<SubString>>
    {
        ...
        public IEnumerable<SubString> Split(SubString input)
        {
            if (input.IsNull)
                yield break;
            ...
            while (index < limit
                   && (HandleSpecialCase(source, ref index, limit, out var match)
