...
namespace Unity.Muse.Chat.Embeddings.Tokenization.Decoders
{
    ...
    /// </summary>
    class ByteFallbackDecoder : DecoderBase
    {
        ...
        protected override void DecodeInternal(IEnumerable<string> tokens, IOutput<string> output)
        {
            ...
            foreach (var token in tokens)
                ...
                else
                {
                    ...
                    {
                        output.Write(ConvertByteToToken(previousByteTokens));
        ...
        List<string> ConvertByteToToken(List<byte> previousByteTokens)
        {
            ...
            {
                foreach (var b in previousByteTokens) returnTokens.Add("�");
            }
