...
namespace Unity.Muse.Chat.Embeddings.Tokenization.PaddingProcessors
{
    ...
    /// </summary>
    abstract class DirectionalPaddingProcessorBase : PaddingProcessorBase
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="DirectionalPaddingProcessorBase" />
        ///     type.
        /// </summary>
        ...
        /// </exception>
        protected DirectionalPaddingProcessorBase(
            ...
            IOutput<IEnumerable<(int id, int attention)>> output)
        {
            ...
            foreach (var sequence in sequenceList)
                output.Write(sequence.Count >= padSize
