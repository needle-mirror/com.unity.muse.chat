...
namespace Unity.Muse.Chat.UI
{
    class ChatElementActionEntry : ManagedTemplate
    {
        ...
        AgentAction m_AgentAction;
        bool m_ItemizeAction;

        Action m_Action;

        public ChatElementActionEntry(string previewText, AgentAction agentAction)  : base(MuseChatConstants.UIModulePath)
        {
            m_PreviewText = previewText;
            m_AgentAction = agentAction;
        }
