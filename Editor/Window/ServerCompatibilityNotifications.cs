...
namespace Unity.Muse.Chat.UI
{
    class ServerCompatibilityNotifications : VisualElement
    {
        ...
        VisualElement View(Model model)
        {
            ...
            if(ServerCompatibility.Status == ServerCompatibility.CompatibilityStatus.Unsupported)
                return new ServerCompatibilityNotSupportedNotificationView();

            if(ServerCompatibility.Status == ServerCompatibility.CompatibilityStatus.Deprecated)
