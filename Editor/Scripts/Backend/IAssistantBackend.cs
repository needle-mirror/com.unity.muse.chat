...
namespace Unity.Muse.Chat
{
    interface IAssistantBackend
    {
        ...
        Task<MuseChatStreamHandler> SendPrompt(MuseConversationId conversationId, string prompt, EditorContextReport context, ChatCommandType commandType, List<MuseChatContextEntry> selectionContext, CancellationToken ct = default);
        ...
        Task EditCode(MuseMessageId messageId, string newContent, CancellationToken ct = default);
