...
namespace Unity.Muse.Chat
{
    class AssistantNullBackend : IAssistantBackend
    {
        ...
        public Task<MuseChatStreamHandler> SendPrompt(MuseConversationId conversationId, string prompt, EditorContextReport context,
            ChatCommandType commandType, List<MuseChatContextEntry> selectionContext, CancellationToken ct = default)
        {
        ...
        public Task EditCode(MuseMessageId messageId, string newContent, CancellationToken ct = default)
        {
            return Task.CompletedTask;
        }
