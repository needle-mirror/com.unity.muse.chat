...
namespace Unity.Muse.Chat
{
    ...
    {
        private Task<ApiResponse<object>> m_CurrentBetaEntitlementCheckRequest;
        private List<Action<bool>> m_BetaEntitlementCheckCallbacks = new();

        public void IsBetaConsoleEntitled(ILoopRegistration loop, Action<bool> onComplete)
        {
            try
            {
                ...
                m_CurrentBetaEntitlementCheckRequest = api.GetMuseBetaCheckEntitlementV1Async(CancellationToken.None);
