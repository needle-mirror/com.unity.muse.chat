...
namespace Unity.Muse.Chat.UI.Components.ChatElements
{
    class ChatElementActionBlock : ManagedTemplate
    {
        ...
        AgentRunCommand m_Action;

        MuseMessage m_ParentMessage;

        RunCommandInterpreter m_CommandInterpreter;
        ...
        {
            m_CommandInterpreter = Assistant.instance.RunCommandInterpreter;
        }
        ...
        {
            m_WarningContainer.SetDisplay(false);
            m_CodePreviewFoldout.text = "Command logic";
        ...
        {
            m_Action = m_CommandInterpreter.BuildCommand(m_CodeContent);
            ...
            else
            {
                ...
                if (!Assistant.instance.IsUnderRepair(m_ParentMessage.Id))
                {
                    ...
                    m_CodeContent = await m_CommandInterpreter.RepairAction(m_ParentMessage.Id, m_ParentMessage.MessageIndex, m_Action.CompilationLogs, m_Action.Script);
        ...
        void DisplayCompilationWarning()
        {
            ...
            m_CodePreviewFoldout.text = "Command logic (errors)";
            ...
            else if (m_Action.IsUsingDeprecatedStructure())
                m_WarningText.text =  "<b>This script was generated with an outdated version and is no longer compatible. Please re-submit your query.";
            else
        ...
        void OpenTemporaryScript()
        {
            m_TempEditedFilePath = AssemblyCSProject.CreateTemporaryFile();

            File.WriteAllText(m_TempEditedFilePath, m_Action.Script);
        ...
        void OnFocusChanged(bool focused)
        {
            ...
            {
                string updatedContent = File.ReadAllText(m_TempEditedFilePath);

                Assistant.instance.ProcessEditScript(updatedContent, m_ParentMessage.Id);
        ...
        void ExecuteAction()
        {
            ...
            m_CommandInterpreter.StoreExecution(executionResult);
