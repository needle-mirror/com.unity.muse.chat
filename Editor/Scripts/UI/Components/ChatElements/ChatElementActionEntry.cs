...
namespace Unity.Muse.Chat.UI.Components.ChatElements
{
    class ChatElementActionEntry : ManagedTemplate
    {
        ...
        public ChatElementActionEntry(string previewText, AgentRunCommand agentRunCommand)  : base(MuseChatConstants.UIModulePath)
        {
        ...
        VisualElement CreateFieldForType(FieldInfo fieldInfo, object instance)
        {
            ...
            {
                var objectField = new ObjectField { objectType = fieldType, value = (Object)value };
