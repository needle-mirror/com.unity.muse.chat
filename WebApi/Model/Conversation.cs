...
namespace Unity.Muse.Chat.Model
{
    ...
    internal partial class Conversation
    {
        ...
        /// <param name="context">Additional context for the conversation.</param>
        public Conversation(string id = default(string), string title = default(string), List<ConversationFragment> history = default(List<ConversationFragment>), List<string> owners = default(List<string>), List<string> tags = default(List<string>), string context = default(string))
        {
        ...
        /// </summary>
        /// <value>Additional context for the conversation.</value>
