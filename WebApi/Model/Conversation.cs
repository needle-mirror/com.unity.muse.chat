...
namespace Unity.Muse.Chat.Model
{
    ...
    internal partial class Conversation
    {
        ...
        public Conversation(string id = default(string), string title = default(string), List<ConversationFragment> history = default(List<ConversationFragment>), List<string> owners = default(List<string>), List<string> tags = default(List<string>), string context = default(string), List<FunctionDefinition> functionCatalog = default(List<FunctionDefinition>))
        {
