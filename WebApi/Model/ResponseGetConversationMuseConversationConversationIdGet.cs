...
namespace Unity.Muse.Chat.Model
{
    ...
    internal partial class ResponseGetConversationMuseConversationConversationIdGet : AbstractOpenAPISchema
    {
        ...
        /// with the <see cref="Conversation" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of Conversation.</param>
        public ResponseGetConversationMuseConversationConversationIdGet(Conversation actualInstance)
        {
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(Conversation))
                {
                ...
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: Conversation, ErrorResponse");
                }
            }
        }

        /// <summary>
        /// Get the actual instance of `Conversation`. If the actual instance is not `Conversation`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of Conversation</returns>
        public Conversation GetConversation()
        {
            return (Conversation)this.ActualInstance;
        }
        ...
        public static ResponseGetConversationMuseConversationConversationIdGet FromJson(string jsonString)
        {
            ...
            try
            {
                newResponseGetConversationMuseConversationConversationIdGet = new ResponseGetConversationMuseConversationConversationIdGet(JsonConvert.DeserializeObject<Conversation>(jsonString, ResponseGetConversationMuseConversationConversationIdGet.SerializerSettings));
            ...
            catch (Exception exception)
            {
                ...
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into Conversation: {1}", jsonString, exception.ToString()));
            }
    ...
    /// </summary>
    public class ResponseGetConversationMuseConversationConversationIdGetJsonConverter : JsonConverter
    {
        /// <summary>
