...
namespace Unity.Muse.Chat.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FOSSChatRequest")]
    internal partial class FOSSChatRequest
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FOSSChatRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FOSSChatRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FOSSChatRequest" /> class.
        /// </summary>
        ...
        public FOSSChatRequest(string prompt = default(string), string conversationId = default(string), bool streamResponse = default(bool), string organizationId = default(string), List<string> unityVersions = default(List<string>), Dictionary<string, string> dependencyInformation = default(Dictionary<string, string>), Dictionary<string, string> projectSummary = default(Dictionary<string, string>), string mediationSystemPrompt = default(string), bool skipPlanning = false, List<string> tags = default(List<string>), AssistantModelsMuseRequestsModelParameters planningParams = default(AssistantModelsMuseRequestsModelParameters), AssistantModelsMuseRequestsModelParameters mediationParams = default(AssistantModelsMuseRequestsModelParameters), int seed = default(int), string context = default(string), bool mixtralPlanning = true, bool mixtralMediation = true)
        {
            ...
            {
                throw new ArgumentNullException("organizationId is a required property for FOSSChatRequest and cannot be null");
            }
            ...
            this.MixtralPlanning = mixtralPlanning;
            this.MixtralMediation = mixtralMediation;
        }
        ...
        /// <summary>
        /// Whether to use Mixtral 8x7B planning system. Default is true.
        /// </summary>
        /// <value>Whether to use Mixtral 8x7B planning system. Default is true.</value>
        [DataMember(Name = "mixtral_planning", EmitDefaultValue = true)]
        public bool MixtralPlanning { get; set; }

        /// <summary>
        /// Whether to use Mixtral 8x7B mediation system. Default is true.
        /// </summary>
        /// <value>Whether to use Mixtral 8x7B mediation system. Default is true.</value>
        [DataMember(Name = "mixtral_mediation", EmitDefaultValue = true)]
        public bool MixtralMediation { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FOSSChatRequest {\n");
            ...
            sb.Append("  MixtralPlanning: ").Append(MixtralPlanning).Append("\n");
            sb.Append("  MixtralMediation: ").Append(MixtralMediation).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
